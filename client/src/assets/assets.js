...
export const AiToolsData = [
  {
    ...
    description: 'Craft compelling, well-structured content on any subject instantly with advanced AI assistance.',
    Icon: SquarePen,
    bg: { from: '#4A90E2', to: '#007AFF' },  // Soft blue gradient
    path: '/ai/write-article'
  },
  {
    title: 'Catchy Blog Titles',
    description: 'Generate attention-grabbing titles that boost clicks and reader engagement effortlessly.',
    Icon: Hash,
    bg: { from: '#A34EF5', to: '#D16DDF' },  // Violet-pink gradient
    path: '/ai/blog-titles'
  },
  {
    title: 'Visual Generator',
    description: 'Design eye-catching visuals in seconds using the power of artificial intelligence.',
    Icon: Image,
    bg: { from: '#22CDAA', to: '#13B8A1' },  // Aqua-green gradient
    path: '/ai/generate-images'
  },
  {
    title: 'Smart Background Remover',
    description: 'Remove backgrounds from images with pixel-perfect AI precision—fast and clean.',
    Icon: Eraser,
    bg: { from: '#FF7C4C', to: '#FF4E50' },  // Warm orange-red gradient
    path: '/ai/remove-background'
  },
  {
    title: 'Erase Image Objects',
    description: 'Remove unwanted objects from images seamlessly while keeping the quality intact.',
    Icon: Scissors,
    bg: { from: '#6C5CE7', to: '#4C7FFF' },  // Blue-violet gradient
    path: '/ai/remove-object'
  },
  {
    title: 'AI Resume Analyzer',
    description: 'Enhance your resume with smart suggestions that boost your chances of success.',
    Icon: FileText,
    bg: { from: '#00C9A7', to: '#00B3C6' },  // Teal-cyan gradient
